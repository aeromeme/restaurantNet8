...
namespace Application.Services
{
    public class OrderAppService : IOrderAppService
    {
        ...
        public async Task<IEnumerable<Order>> GetAllAsync() => await _unitOfWork.Orders.GetAllWithDetailAsync();
        

        public async Task<Order?> GetByIdAsync(int id) => await _unitOfWork.Orders.GetByIdWithDetailAsync(id);
        ...
        public async Task<(bool Success, string Message)> UpdateAsync(OrderDto updateOrderDto)
        {
            ...
            try
            {
                ormOrder.Validate(); // Domain logic
            }
            catch (ArgumentException ex)
            {
            ...
            _mapper.Map(updateOrderDto, ormOrder);
            ...
            foreach (var detailDto in ormOrder.OrderDetails)
            {
